**Pertidaksamaan Linear Satu Variabel (PLSV)** adalah pertidaksamaan matematika yang melibatkan sebuah variabel dengan pangkat tertinggi 1 (linear). Bentuk umumnya adalah:
